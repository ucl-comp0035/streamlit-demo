...
from backend.models.models import Country, Disability, Games, GamesDisability, GamesHost, GamesTeam, Host, Team  # noqa
...
def create_db_and_tables():
    ...
    # # If any table already contains rows, assume data exists and do nothing, otherwise add the data
